...
- **[NVIDIA/NVSentinel](https://github.com/NVIDIA/NVSentinel)** — [#1647](https://github.com/NVIDIA/NVSentinel/issues/1647): demo scripts reporting success without checking the result. [First-run notes](./nvsentinel-first-run-notes).
